...
public class NetworkInfoObtainer {
    ...
    public static String getNetworkType(String networkName) {
        ...
        if(networkName.contains("BANGLALINK")){
            return "MOBILE";
        }
        else if(networkName.contains("AIRTEL")){
            return "MOBILE";
        }
        else if(networkName.contains("ROBI")){
            return "MOBILE";
        }
        else if(networkName.contains("GP")){
            return "MOBILE";
        }
        else if(networkName.contains("GRAMEENPHONE")){
            return "MOBILE";
        }
        return "ISP";
    }
