...
//    TableColumn btnCol2 = new TableColumn("Reject Column");
    ...
    @FXML
    private TableColumn col_currentRoomNumber;
    @FXML
...
//        );
        ...
        col_currentRoomNumber.setCellValueFactory(
                new PropertyValueFactory<>("currentRoomID")
        );
...
//        );
    ...
    public void runRejected(String applicationID, String applicationStatus, String studentId, String currentRoomID, String hasRoom, String applicationDate) throws Exception {
