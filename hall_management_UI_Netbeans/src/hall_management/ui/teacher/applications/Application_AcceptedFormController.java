...
//            refreshInfo();
    ...
    private void acceptThisApplication(ActionEvent event) {
        try{
//            Application_Queries.
            Application_Queries.updateApplicationFieldForDate(Application_AcceptedFormController.applicationID, "VERDICT_DATE", Application_Queries.makeCurrentDate());
...
//        System.out.println("=--->>>BUTTON CLICKED FOR ROOM NUM = " + roomNum);
    ...
    @FXML
    private void rejectThisApplication( ) throws Exception{
...
//        System.out.println("APPLICATION STATUS FOR APP_ID = " + this.applicationID + " is " + this.applicationStatus);
        if (true) {
            Application_Queries.updateApplicationFieldForDate(this.applicationID, "VERDICT_DATE", Application_Queries.makeCurrentDate());
            Application_Queries.updateApplicationField(this.applicationID, "STATUS", "REJECTED");
        }
        Notification.push("SUCCES!", "APPLICATION ID: " + this.applicationID + " IS DELETED!", Notification.SUCCESS);
        SceneLoader.closeScene(SceneLoader.CurrentScene());
//        SceneLoader.loadPreviousScene(Scenes.teacher_see_Applications, this);
        SceneLoader.loadScene(Scenes.teacher_see_Applications, this);
        //LOAD NEW SCENE TO GET RID OF THIS REJECTED APPLICATION
    }
