class TCPDescription:
    ...
    def __init__(self):
        self.is_tor_not_connected = 0  # Default 0
        self.is_time_out = 0  # Default false
        self.is_fin_bit_set = 0  # Default 0
        self.is_rst_bit_set = 0  # Default 0

        # If not censored then there should be iteration successful
        self.successful_iteration_number_local_server = 0  # Default 0 [Local Server]
        self.successful_iteration_number_tor = 0  # Default is 0 [Tor Browser]
        self.is_tor_connect_successful = 1

        # Middle box hop count
        self.middle_box_hop_count = -1

        # Is TCP Censored ... is_censored_TCP [INTEGER] in database .... to handle from report_arr
        self.is_censored_TCP = 0
