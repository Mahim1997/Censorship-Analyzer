class DNSDescription:
    ...
    def __init__(self):
        ...
        del self.ip_address_list_local[:]
        del self.ip_address_list_stubby[:]
        self.is_timeout = 0
        self.is_loopback = 0
        self.is_multicast = 0
        self.is_broadcast = 0
        self.is_private = 0
        self.is_bogon = 0
        self.is_unknown_error = 0
        self.is_reserved = 0
        self.is_nxDomain = 0
        self.is_noAnswerPacket = 0
        self.is_stubby_failed = 0
        self.is_topExistingButAuthNotExisting = 0  # Top level DNS Server has this domain but the authorative dns servers do not
        self.is_timeout_local_server = 0

        # IS overlapping or not ?
        self.is_non_overlapping_ip_list = 0  # Default 0/False
        self.is_first_8_to_24_bit_match = 0  # Default False
